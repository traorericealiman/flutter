            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    _buildCategoryItem("Tous", 8),
                    _buildCategoryItem("Homme", 0),
                    _buildCategoryItem("Shoes", 1),
                    _buildCategoryItem("Enfant", 2),
                    _buildCategoryItem("Pull", 3),
                    _buildCategoryItem("T-shirt", 4),
                    _buildCategoryItem("Culotte", 5),
                    _buildCategoryItem("Jogging", 6),
                    _buildCategoryItem("Femme", 7),
                  ],
                ),
              ),
            ),
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Color.fromARGB(255, 219, 219, 176)
                              .withOpacity(0.5),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Stack(
